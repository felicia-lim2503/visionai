...
global.CONFIG.AUTH_USER_STORE_NAME = 'identities'
global.CONFIG.AUTH_USER_FIELD_ID_FOR_JWT = 'id' // mongo = _id, knex = id // can be NTID from SAML
global.CONFIG.AUTH_USER_FIELDS_JWT_PAYLOAD = 'email,roles,referral_code,first_name,last_name,activated,aasm_state' // comma seperated, can be AD Groups from SAML, email, etc.
...
// AUTH - OTP
global.CONFIG.USE_OTP = 'GA' // GA, SMS, '' (also on FE) set to TEST for testing using 111111 as PIN
