...
module.exports = {
  ...
  OPENAI_API: "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",

  USE_GRAPHQL: true,
  CORS_ORIGINS: [
    "http://127.0.0.1:8080",
    "http://127.0.0.1:3000",
    "http://127.0.0.1:8081", // port 8081 is from SAML
    "https://127.0.0.1:8080",
    "https://127.0.0.1:3000",
    "https://127.0.0.1:8081", // port 5500 ? unknown
    "https://192-168-18-8.nip.io:3000",
    "http://localhost:3000",
    "http://localhost:8080",
    "http://127.0.0.1:8080", // fido2 testing
  ].join(","),
  ...
  WEB_STATIC: [
    ...
    {
      folder: "../../js-web/vue-nobundler",
      url: "/native",
      options: { extensions: ["html"], index: false },
    },
    {
      folder: "../../js-web/vue-vite/dist",
      url: "/vite",
      options: { extensions: ["html"], index: false },
    },
    {
